...
servlet.setTransformWsdlLocations(true); return new ServletRegistrationBean(servlet, "/webservice/*");
}
@Bean(name = "marks")
...
@Bean
public XsdSchema marksSchema() { return new SimpleXsdSchema(new ClassPathResource("marks.xsd"));
}
}